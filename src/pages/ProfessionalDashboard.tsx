                            ...
                            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                                {patientTab === 'panel' && (
                                    <div className="space-y-8 animate-in fade-in duration-300">
                                        ...
                                        {/* Monitorização Clínica Completa e Gráficos */}
                                        <div className="pt-10 border-t border-gray-150 space-y-6">
                                            <div className="flex items-center space-x-3 mb-2">
                                                <div className="p-2.5 bg-emerald-50 rounded-2xl text-[#006747]">
                                                    <Activity className="w-5 h-5 text-[#006747]" />
                                                </div>
                                                <div className="text-left">
                                                    <h4 className="text-xs font-black text-gray-950 uppercase tracking-widest">Monitorização Clínica Completa</h4>
                                                    <p className="text-[10px] text-gray-400 mt-0.5 font-semibold">Sinais vitais em tempo real, monitor multiparâmetros, eletrocardiograma e mapa de sintomas</p>
                                                </div>
                                            </div>
                                ...
                                {patientTab === 'monitoring' && (
                                    <ClinicalMonitoringTab 
                                        ...
                                        showNotification={(msg, type) => showNotification(msg, type === 'warning' || type === 'info' ? 'error' : type)}
                                        onlyInputs={true}
                                        onRefresh={() => fetchPatientDetails(selectedPatient.id)}
                                    />
                                )}
